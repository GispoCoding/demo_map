...
lyr_Voronoipolygons_1.set('fieldAliases', {'fid': 'fid', 'name': 'name', });
lyr_Pubs_3.set('fieldAliases', {'fid': 'fid', 'address': 'address', 'name': 'name', 'url': 'url', 'why bother': 'why bother', });
lyr_Voronoipolygons_1.set('fieldImages', {'fid': 'TextEdit', 'name': 'TextEdit', });
lyr_Pubs_3.set('fieldImages', {'fid': 'TextEdit', 'address': 'TextEdit', 'name': 'TextEdit', 'url': 'TextEdit', 'why bother': '', });
lyr_Voronoipolygons_1.set('fieldLabels', {'fid': 'no label', 'name': 'no label', });
lyr_Pubs_3.set('fieldLabels', {'fid': 'no label', 'address': 'inline label', 'name': 'inline label', 'url': 'inline label', 'why bother': 'inline label', });
